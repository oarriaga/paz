...
lens_base_transform = lens_shift @ lens_scale @ lens_angle
lens_base = paz.graphics.Cylinder(lens_base_transform, grey_material)
...
camera = [body, lens_base, lens_barrel, lens_element, button, viewfinder]
camera = paz.graphics.Group(camera)

paz.graphics.save("assets/camera.json", camera)

scene = paz.graphics.Scene([camera])
