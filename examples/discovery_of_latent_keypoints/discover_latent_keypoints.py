...
parser.add_argument('-nk', '--num_keypoints', default=20, type=int,
...
save_path = os.path.join(os.path.expanduser('~'), '.keras/altamira/models/')
...
keypoints_set, projector = [], Projector(input_shape, focal_length, True)
