...
class Handpose_loader(Loader):
    def __init__(self, path, split='train', image_size=(256, 256, 3),
        ...
        self.split_to_folder = {'train': 'training', 'val': 'validation',
                                'test': 'testing'}
        ...
        self.crop_image_hand_localization = image_crop
    ...
    def _get_geometric_entities(self, vector, transformation_matrix):
        ...
        matrix_after_y_rotation = np.matmul(get_transformation_matrix_y(
            -gamma), vector)
    ...
    def _to_list_of_dictionaries(self, hands, segmentation_labels=None,
        ...
        for arg in range(len(hands)):
            ...
            if annotations is not None:
                ...
                dominant_hand = self._extract_hand_side(sample['hand_mask'],
