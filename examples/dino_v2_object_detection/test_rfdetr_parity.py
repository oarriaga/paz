...
from examples.dino_v2_object_detection.detr import (
    RFDETR as K_RFDETR,
...
from examples.dino_v2_object_detection.main import (
    Model as K_Model,
    PostProcess as K_PostProcess,
    build_model_from_config,
    build_criterion_from_config,
)
from examples.dino_v2_object_detection.utils.coco_classes import COCO_CLASSES

# ---- Weight-transfer utilities (reused from the LWDETR parity suite) -----
if HAS_TORCH:
    from examples.dino_v2_object_detection.models.lwdetr.test_lwdetr_with_real_weights import (
...
class TestPostProcessParity:
    ...
    def test_postprocess_scores_parity(self):
        from examples.dino_v2_object_detection.models.lwdetr import lwdetr as k_module
