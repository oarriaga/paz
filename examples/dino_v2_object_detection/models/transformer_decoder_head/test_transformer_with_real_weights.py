...
try:
    ...
    rfdetr_path = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../../../rf-detr_original_pytorch_implementation")
    )
...
from examples.dino_v2_object_detection.models.transformer_decoder_head.transformer import Transformer as KerasTransformer
from examples.dino_v2_object_detection.models.transformer_decoder_head.transformer import MLP as KerasMLP
