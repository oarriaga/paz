...
try:
    ...
    from examples.dino_v2_object_detection.models.transformer_decoder_head.ms_deform_attn import MSDeformAttn as KerasMSDeformAttn
...
try:
    ...
    rfdetr_root = os.path.abspath(os.path.join(current_dir, '../../../rf-detr_original_pytorch_implementation'))
