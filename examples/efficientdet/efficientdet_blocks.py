...
def BiFPN(features, num_channels, id, fpn_weight_method):
    if id == 0:
        ...
        P6_in = Conv2D(
            num_channels, 1, 1, 'same', name='resample_p6/conv2d')(C5)
...
class FuseFeature(Layer):
    ...
    def call(self, inputs, fpn_weight_method, **kwargs):
