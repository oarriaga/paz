...
class MaskRCNN():
    ...
    def build(self):
        ...
        if callable(self.config.BACKBONE):
            ...
            _, C2, C3, C4, C5 = utils.resnet_graph(input_image, self.config.BACKBONE,
        ...
        model = KM.Model([input_image], [P2, P3, P4, P5, P6])
        ...
        #         utils.fpn_classifier_graph(rois, mrcnn_feature_maps, input_image_meta,
        #                              config.POOL_SIZE, config.NUM_CLASSES,
        #                              mode=mode, train_bn=config.TRAIN_BN,
        #                              fc_layers_size=config.FPN_CLASSIF_FC_LAYERS_SIZE)

        #     mrcnn_mask = utils.build_fpn_mask_graph(rois, mrcnn_feature_maps,
        #                                       input_image_meta,
        ...
        # else:
            ...
            # mrcnn_class_logits, mrcnn_class, mrcnn_bbox =\
            #     utils.fpn_classifier_graph(rpn_rois, mrcnn_feature_maps, input_image_meta,
            #                          config.POOL_SIZE, config.NUM_CLASSES,
            #                          mode=mode, train_bn=config.TRAIN_BN,
            #                          fc_layers_size=config.FPN_CLASSIF_FC_LAYERS_SIZE)
    ...
    def RPN(self, rpn_feature_maps):
        # RPN Model
        rpn = utils.build_rpn_model(self.config.RPN_ANCHOR_STRIDE,
    ...
    def compile(self, learning_rate, momentum):
        ...
        for name in loss_names:
            ...
            #if layer.output.name in self.keras_model.losses:
