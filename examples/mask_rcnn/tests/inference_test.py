...
@pytest.mark.parametrize('ones', [(37370, 5109, 29785, 22668, 3827, 103587,
                                   28364, 1817, 28940, 14946, 1100, 28544)])
...
@pytest.mark.parametrize('classes', [(1,  59, 1,  1,  59, 63,  1,  76, 58,
                                      1, 76, 58)])
