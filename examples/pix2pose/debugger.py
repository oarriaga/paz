...
renderer = PixelMaskRenderer(OBJ_FILEPATH, viewport_size, y_fov, distance,
...
print(object_sizes)
model = UNET_ConvNeXtBase(3, image_shape, freeze_backbone=True)
model.load_weights('experiments/UNET-ConvNeXtBase_RUN_00_13-07-2023_14-11-34/model_weights.hdf5')
...
image, alpha, RGBA_mask, gt_pose = renderer.render()
print('*********************************')
print(gt_pose)
print('*********************************')
