...
parser = argparse.ArgumentParser(description="Probabilistic keypoints demo")
...
parser.add_argument("--output", default="probabilistic_keypoints.jpg")
args = parser.parse_args()

estimate = paz.applications.DetectGMMKeypointNet2D()
