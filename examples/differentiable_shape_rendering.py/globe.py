...
def build_checkered_pattern(
    box_size=50, rows=8, cols=8, color_A=(0, 0, 0), color_B=(1, 1, 1)
):
...
zero_pattern = paz.graphics.Pattern()
...
if checkboard:
    base = Base(
        SE3.translation([0.0, -1.7, 0.0]), zero_material, checkboard_pattern_2
    )
else:
