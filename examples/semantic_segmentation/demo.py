...
parser = argparse.ArgumentParser(description="UNet Shapes segmentation demo")
parser.add_argument("--image", default=None, help="RGB image; Shapes if unset")
parser.add_argument("--weights", default="experiments/unet_shapes.weights.h5")
parser.add_argument("--image_size", default=128, type=int)
parser.add_argument("--output", default="unet_segmentation.jpg")
...
if args.image is not None:
    ...
    image = np.asarray(shapes.load(H, W, 0.3, 3, 1)[0][0])
