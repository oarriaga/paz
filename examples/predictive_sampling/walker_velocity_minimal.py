...
def WalkerVelocityMinimal(impl="jax"):
...
task, model = WalkerVelocityMinimal(impl="warp" if args.warp else "jax")
sampler = KnotSampler(model, 256, 5, 1.0, 1.5, interpolate_zero)
