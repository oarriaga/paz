...
# FLOOR
if checkboard:
    floor_image = CheckeredImage(50, 8, 8, WHITE, GREEN)
...
# WALL
if checkboard:
    wall_image = CheckeredImage(50, 8, 8, WHITE, GREEN)
...
# shapes = [floor]
scene = paz.graphics.Scene([floor, wall])
...
image_name = "wall_checkboard.png" if checkboard else "wall.png"
