...
try:
    from paz.models.detection.dino_v2_object_detection.models.backbone.projector import (
        MultiScaleProjector as KerasMultiScaleProjector,
        SimpleProjector as KerasSimpleProjector,
        ConvX as KerasConvX,
        C2f as KerasC2f
    )
    from paz.models.detection.dino_v2_object_detection.models.backbone.projector_weights_porting_utils import (
        copy_conv2d,
        copy_bn,
        copy_ln,
        copy_weights_convx,
