...
def compute_cubic_weights(t):
    w0 = compute_cubic_far(t + 1)
    w1 = compute_cubic_near(t)
    w2 = compute_cubic_near(1 - t)
    w3 = compute_cubic_far(2 - t)
...
def find_mutual_nearest_neighbors(descriptors1, descriptors2, min_cosine=-1.0):
