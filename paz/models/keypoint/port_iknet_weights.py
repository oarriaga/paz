...
from paz.models.keypoint.iknet import WEIGHT_PATH


DEFAULT_OUTPUT_PATH = "~/.keras/paz/models/iknet_paz_jax.weights.h5"
...
def build_argument_parser():
    ...
    parser.add_argument("--input_shape", nargs=2, type=int, default=(84, 3))
