...
from ..datasets import (RGB_LINEMOD_MEAN, LINEMOD_CAMERA_MATRIX,
                        get_class_names, LINEMOD_OBJECT_SIZES)
from ..models.pose_estimation.efficientpose import EfficientPosePhi0
...
class AugmentEfficientPose(SequentialProcessor):
    ...
    def __init__(self, model, split=pr.TRAIN, num_classes=8, size=512,
        ...
        self.augment_6DOF = pr.Augment6DOF(probability=probability,
                                           input_size=size)
