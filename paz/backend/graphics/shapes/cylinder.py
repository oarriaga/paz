...
from paz.backend.graphics.shapes.ring import build_canonical_ring_normals
from paz.backend.graphics.shapes.quadratics import intersect_canonical_cylinder
